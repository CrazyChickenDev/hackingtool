...
class SQLiScanner(HackingTool):
    ...
    DESCRIPTION = (
        "Damn Small SQLi Scanner (DSSS) is a fully functional SQL "
...
class Explo(HackingTool):
    TITLE = "Explo"
    DESCRIPTION = (
        "Explo is a simple tool to describe web security issues "
...
class Blisqy(HackingTool):
    ...
    DESCRIPTION = (
        "Blisqy is a tool to aid Web Security researchers to find "
...
class Leviathan(HackingTool):
    ...
    DESCRIPTION = (
        "Leviathan is a mass audit toolkit which has wide range "
